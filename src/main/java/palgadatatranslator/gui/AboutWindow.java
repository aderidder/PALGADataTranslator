...
class AboutWindow {
    ...
    /**
     * creates the top part of the about window
     * @return in this case just a title
     */
    ...
    /**
     * creates the center part of the about window
     * @return a component with a text area
     */
    ...
    /**
     * creates the bottom part of the about window
     * @return a grid pane
     */
...
//        grid.add(palgaImv,4,0,2,1);
    ...
    /**
     * functionality to create an image view
     * @param height height of the image view
     * @param width  width of the image view
     * @param image  image name, expected in resources/images
