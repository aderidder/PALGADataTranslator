...
package palgadatatranslator.utils;

import java.util.*;
import java.util.stream.Collectors;

/**
 * class that helps out with the PALGA headernames which can contain roman numbers for repeats
...
public class Romans {
    ...
    public static List<String> romanNumberMatch(String value){
        ...
        List<String> matchedRomans = romanNumbers.stream().filter(t->value.toUpperCase().endsWith(t)).collect(Collectors.toList());
